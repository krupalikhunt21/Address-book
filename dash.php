...
echo  $checkuser = "select * from dashboard where uid='$uid'";
...
$insert_dashboard="INSERT INTO `dashboard` (
...
if($query)
{
?><script>alert("Record Inserted Successfully...");window.location.href="Dashboard.php";</script><?php
}
}
?>
